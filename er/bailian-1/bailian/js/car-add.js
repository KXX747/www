class Car{
    constructor(){
        this.url = "http://localhost/bailian-1/bailian/data/shopdetail.json";
    ...
    getLocal(){
        this.goods = localStorage.getItem("shopdetail") ? JSON.parse(localStorage.getItem("shopdetail")) : [];
        this.display();
    }
    display(){
        let str = "";
    ...
    setLocal(fn){
        ...
        localStorage.setItem("shopdetail",JSON.stringify(this.goods));
    }
}
new Car();