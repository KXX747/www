;(function(){
    ...
    class Project{
        constructor(){
            ...
            this.insertUrl = "http://localhost/1907/project/ctrl/insert.php";
            this.updateUrl = "http://localhost/1907/project/ctrl/update.php";
            this.selectUrl = "http://localhost/1907/project/ctrl/select.php";
            this.deleteUrl = "http://localhost/1907/project/ctrl/delete.php";
        ...
        addEvent(){
            ...
            this.tbody.addEventListener("click",function(eve){
                ...
                if(eve.target.getAttribute("abc") == "delete"){
                    console.log(1)
        ...
        display(){
            ...
            for(var i=0;i<this.res.length;i++){
                str += `<tr>
                            ...
                            <td><span class="btn btn-warning" abc="delete">删除</span></td>
