...
//创建数据库之类的   php5.x -> 7.x  变化 mysql-》mysqli  xx_query(第一个参数是库连接变量$db)/xx_select_db($db)
$db=@mysqli_connect('localhost', 'root', 'root') or @mysqli_connect('localhost', 'root', '');

mysqli_query($db,"set names 'utf8'");
mysqli_query($db,'CREATE DATABASE ajax');
